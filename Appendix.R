...
tabDes_temp <- MainDB  %>% 
  mutate(
    ...
    AppCrecheNP = as.factor(ifelse(AppCrecheNP == 1, "Yes", "No")),
    ECSUseYes = as.factor(ifelse(ECSUseYes == 1, "Yes", "No")),
    UseCrecheNP = as.factor(ifelse(UseCrecheNP == 1, "Yes", "No"))
  ) %>%
  select(
    ...
    DepParis, HighECSCov, GenderChild, ECSApp, AppCrecheNP,
    ECSUseYes, UseCrecheNP
  )
...
tbl_summary <- tabDes_temp  %>%
  tbl_summary(
    ...
    label = list(
      ...
      AppCrecheNP ~ "Applied to non-profit daycare center at endline",
      ECSUseYes ~ "Accessed any early childcare facility at endline",
      UseCrecheNP ~ "Accessed non-profit daycare center at endline"
    )
  ) %>%
...
tabVarEduc <- MainDB  %>% 
  ...
  select(
    ...
    "Applied to any daycare center at endline" = AppCrecheNP,
    "Accessed any early childcare facility at endline" = ECSUseYes, 
    "Accessed any daycare center at endline" = UseCrecheNP
  )
...
tabVarDep <- MainDB  %>% 
  ...
  select(Dep,
         ...
         #  StrataWave
         "Applied to any early childcare facility at endline" = ECSApp, 
         "Applied to non-profit daycare center at endline" = AppCrecheNP,
         "Accessed any early childcare facility at endline" = ECSUseYes, 
         "Accessed non-profit daycare center at endline" = UseCrecheNP
  )
...
modelsummary(list("Non-profit daycare application_Control mean"  =Het.ITT.App.Dev.Daycare$ModelSummary0,
                  "Non-profit daycare application_ITT"           =Het.ITT.App.Dev.Daycare$ModelSummary,
                  "Non-profit daycare application_ATT"           =Het.ATT.App.Dev.Daycare$ModelSummary,
                  "Non-profit daycare access_Control mean"       =Het.ITT.Use.Dev.Daycare$ModelSummary0,
                  "Non-profit daycare access_ITT"                =Het.ITT.Use.Dev.Daycare$ModelSummary,
                  "Non-profit daycare access_ATT"                =Het.ATT.Use.Dev.Daycare$ModelSummary),
             shape = term + Group ~ model,
             fmt=fmt_statistic(estimate=2, adj.p.value=3,std.error=2,conf.int=2,"Chi 2"=2,"P-value"=3), 
             estimate = '{estimate}{stars} ({std.error})',
             statistic = c("conf.int", "adj.p.val. = {adj.p.value}"),
...
modelsummary(list("Non-profit daycare application_Control mean"  =Het.ITT.App.Attitude.Daycare$ModelSummary0,
                  "Non-profit daycare application_ITT"           =Het.ITT.App.Attitude.Daycare$ModelSummary,
                  "Non-profit daycare application_ATT"           =Het.ATT.App.Attitude.Daycare$ModelSummary,
                  "Non-profit daycare access_Control mean"       =Het.ITT.Use.Attitude.Daycare$ModelSummary0,
                  "Non-profit daycare access_ITT"                =Het.ITT.Use.Attitude.Daycare$ModelSummary,
                  "Non-profit daycare access_ATT"                =Het.ATT.Use.Attitude.Daycare$ModelSummary),
             shape = term + Group ~ model,
             fmt=fmt_statistic(estimate=2, adj.p.value=3,std.error=2,conf.int=2,"Chi 2"=2,"P-value"=3), 
             estimate = '{estimate}{stars} ({std.error})',
             statistic = c("conf.int", "adj.p.val. = {adj.p.value}"),
...
# Table for Daycare
modelsummary(list("Non-profit daycare application_Control mean" = Het.ITT.App.BeliefsEduc.Daycare$ModelSummary0,
                  "Non-profit daycare application_ITT" = Het.ITT.App.BeliefsEduc.Daycare$ModelSummary,
                  "Non-profit daycare application_ATT" = Het.ATT.App.BeliefsEduc.Daycare$ModelSummary,
                  "Non-profit daycare access_Control mean" = Het.ITT.Use.BeliefsEduc.Daycare$ModelSummary0,
                  "Non-profit daycare access_ITT" = Het.ITT.Use.BeliefsEduc.Daycare$ModelSummary,
                  "Non-profit daycare access_ATT" = Het.ATT.Use.BeliefsEduc.Daycare$ModelSummary),
             shape = term + Believe + SES ~ model,
             fmt=fmt_statistic(estimate=2, adj.p.value=3, std.error=2, conf.int=2, "Chi 2"=2, "P-value"=3), 
             estimate = '{estimate}{stars} ({std.error})',
             statistic = c("conf.int", "adj.p.val. = {adj.p.value}"),
...
# Table for Daycare
modelsummary(list("Non-profit daycare application_Control mean" = Het.ITT.App.TrustEduc.Daycare$ModelSummary0,
                  "Non-profit daycare application_ITT" = Het.ITT.App.TrustEduc.Daycare$ModelSummary,
                  "Non-profit daycare application_ATT" = Het.ATT.App.TrustEduc.Daycare$ModelSummary,
                  "Non-profit daycare access_Control mean" = Het.ITT.Use.TrustEduc.Daycare$ModelSummary0,
                  "Non-profit daycare access_ITT" = Het.ITT.Use.TrustEduc.Daycare$ModelSummary,
                  "Non-profit daycare access_ATT" = Het.ATT.Use.TrustEduc.Daycare$ModelSummary),
             shape = term + Trust + SES ~ model,
             fmt=fmt_statistic(estimate=2, adj.p.value=3, std.error=2, conf.int=2, "Chi 2"=2, "P-value"=3), 
             estimate = '{estimate}{stars} ({std.error})',
             statistic = c("conf.int", "adj.p.val. = {adj.p.value}"),
...
modelsummary(list("Non-profit daycare application_Control mean"  =Het.ITT.App.Norms.Daycare$ModelSummary0,
                  "Non-profit daycare application_ITT"           =Het.ITT.App.Norms.Daycare$ModelSummary,
                  "Non-profit daycare application_ATT"           =Het.ATT.App.Norms.Daycare$ModelSummary,
                  "Non-profit daycare access_Control mean"          =Het.ITT.Use.Norms.Daycare$ModelSummary0,
                  "Non-profit daycare access_ITT"                   =Het.ITT.Use.Norms.Daycare$ModelSummary,
                  "Non-profit daycare access_ATT"                   =Het.ATT.Use.Norms.Daycare$ModelSummary),
             shape = term + Group ~ model,
             fmt=fmt_statistic(estimate=2, adj.p.value=3,std.error=2,conf.int=2,"Chi 2"=2,"P-value"=3), 
             estimate = '{estimate}{stars} ({std.error})',
             statistic = c("conf.int",
...
modelsummary(list("Non-profit daycare application_Control mean"  =Het.ITT.AppCreche.DepEduc$ModelSummary0,
                  "Non-profit daycare application_ITT"=Het.ITT.AppCreche.DepEduc$ModelSummary,
                  "Non-profit daycare application_ATT"=Het.ATT.AppCreche.DepEduc$ModelSummary,
                  "Non-profit daycare access_Control mean"  =Het.ITT.UseCreche.DepEduc$ModelSummary0,
                  "Non-profit daycare access_ITT"=Het.ITT.UseCreche.DepEduc$ModelSummary,
                  "Non-profit daycare access_ATT"=Het.ATT.UseCreche.DepEduc$ModelSummary),
             shape = term + District+Education ~ model,
             fmt=fmt_statistic(estimate=2, adj.p.value=3,std.error=2,conf.int=2,"Chi 2"=2,"P-value"=3), 
             estimate = '{estimate}{stars} ({std.error})',
             statistic = c("conf.int",
...
# Créer un vecteur nommé pour les étiquettes de l'axe x
x_labels <- c(
  "T1-C!Non-profit daycare application!ISEI Mother" = "ISEI Mother",
  "T1-C!Non-profit daycare application!SES Index" = "SES Index"
)
...
# Créer un vecteur nommé pour les étiquettes de l'axe x
x_labels <- c(
  "T1-C!Access non-profit daycare!ISEI Mother" = "ISEI Mother",
  "T1-C!Access non-proit daycare!SES Index" = "SES Index"
)
...
# Créer un vecteur nommé pour les étiquettes de l'axe x
x_labels <- c(
  "T2-C!Non-profit daycare access!ISEI Mother" = "ISEI Mother",
  "T2-C!Non-profit daycare access!SES Index" = "SES Index"
)
...
modelsummary(list("Application_Control mean"  = Het.ITT.App.IseiMother.DaycareT2$ModelSummary0,
             ...
             coef_map = cm,
             gof_map = c("Covariates", "Fixed effects", "Mean F-stat 1st stage", "Chi 2", "P-value", "nobs", "r.squared", "adj.r.squared"),
             title = "Average effects on non-profit daycare application and access by ISEI Mother",
             notes = paste("Sources:", SourcesStacked,
                           "
*= p<.1, **= p<.05, ***= p<.01 based on point-wise p-value.
Standard errors are cluster-heteroskedasticity robust adjusted at the block x wave level.
...
modelsummary(list("Application_Daycare_Control mean"  = Het.ITT.App.SES.DaycareT2$ModelSummary0,
             ...
             coef_map = cm,
             gof_map = c("Covariates", "Fixed effects", "Mean F-stat 1st stage", "Chi 2", "P-value", "nobs", "r.squared", "adj.r.squared"),
             title = "Average effects on non-profit daycare application and access by SES Index",
             notes = paste("Sources:", SourcesStacked,
                           "
*= p<.1, **= p<.05, ***= p<.01 based on point-wise p-value.
Standard errors are cluster-heteroskedasticity robust adjusted at the block x wave level.
...
# Define labels
OutcomeLabel <- c("Daycare application", "Non-profit daycare access")
...
# Title for modelsummary
TheTitle = "Average gaps and heterogeneous treatment effects of the information-only treatment on Non-profit daycare application and access - Migration Background robustness checks"
...
ITT.ECSAppCrecheNP <- ITTSimultaneous(Y="AppCrecheNP")
...
MainITTResults <- bind_rows(ITT.ECSApp$Tidy %>% mutate(Outcome="Early childcare application",Y=Outcome),
                            ...
                            ITT.UseCreche$Tidy %>% mutate(Outcome="Non-profit daycare access",Y=Outcome),
                            ITT.ECSAppCreche$Tidy   %>% mutate(Outcome="Non-profit daycare application",Y=Outcome),
...
USeCrecheT1C <- EstPostLasso(Y="UseCrecheNP",Z="Z",SubSample = "T1-C")
USeCrecheT2C <- EstPostLasso(Y="UseCrecheNP",Z="Z",SubSample = "T2-C")
USeCrecheT2T1 <- EstPostLasso(Y="UseCrecheNP",Z="Z",SubSample = "T2-T1")
...
TidyUseCrecheLasso <- bind_rows(USeCrecheT1C$`ITT Post lasso` %>% tidy(conf.int = TRUE) %>% mutate(SubSample="T1-C"),
  ...
  mutate(Y="Non-profit daycare access")

# Run lasso on appliation for daycare
ECSAppCrecheT1C <-  EstPostLasso(Y="AppCrecheNP",Z="Z",SubSample = "T1-C")
ECSAppCrecheT2C <-  EstPostLasso(Y="AppCrecheNP",Z="Z",SubSample = "T2-C")
ECSAppCrecheT2T1 <- EstPostLasso(Y="AppCrecheNP",Z="Z",SubSample = "T2-T1")
...
TidyECSAppCrechepLasso <- bind_rows(   ECSAppCrecheT1C$`ITT Post lasso` %>% tidy(conf.int = TRUE) %>% mutate(SubSample="T1-C"),
  ...
  mutate(Y="Non-profit daycare application")
...
OLS_AppCreche <- feols(AppCrecheNP ~ T1 + T2 | StrataWave, data = reg_MainDB, cluster = ~StrataWave)

#(iv) Outcome variable : UseCreche 
OLS_UseCreche <- OLS_UseCreche <- feols(UseCrecheNP ~ T1 + T2 | StrataWave, data = reg_MainDB, cluster = ~StrataWave)
...
# (iii) Outcome variable AppCreche
for (dim in dimensions) {
  formula <- as.formula(paste("AppCrecheNP ~ T1 *", dim, "+ T2 *", dim, "| StrataWave"))
  model <- feols(formula, data = reg_MainDB, cluster = ~StrataWave)
  model <- rename_coefficients(model)
...
# (iv) Outcome variable UseCreche
for (dim in dimensions) {
  formula <- as.formula(paste("UseCrecheNP ~ T1 *", dim, "+ T2 *", dim, "| StrataWave"))
  model <- feols(formula, data = reg_MainDB, cluster = ~StrataWave)
  model <- rename_coefficients(model)
...
#(iii) Outcome variable : AppCrecheNP : 
logit_AppCreche <- feglm(AppCrecheNP ~ T1 + T2 | StrataWave, data = reg_MainDB, family = binomial(), cluster = ~StrataWave)

#(iv) Outcome variable : UseCreche 
logit_UseCreche <- feglm(UseCrecheNP ~ T1 + T2 | StrataWave, data = reg_MainDB, family = binomial(), cluster = ~StrataWave)
...
logit_models <- list(
  ...
  "Non-profit daycare_Application" = logit_AppCreche,
  "Non-profit daycare_Access" = logit_UseCreche
)
...
models_ISEI_logit <- list(
  ...
  "Non-profit daycare_Application" = models_logit_AppCreche[[dimension_to_extract]],
  "Non-profit daycare_Access" = models_logit_UseCreche[[dimension_to_extract]]
)
...
SESl <- modelsummary(list("Early childcare_Application" = SES_ECSAppl, 
                          ...
                          "Non-profit daycare_Application" = SES_AppCrechel, 
                          "Non-profit daycare_Access" = SES_UseCrechel), 
                     estimate = '{estimate}{stars} ({std.error})',
                     statistic = 'conf.int',
                     stars = c('*' = 0.1, '**' = 0.05, '***' = 0.01),
                     gof_map  = c("nobs", "r.squared", "adj.r.squared","Std.Errors", 'FE: StrataWave', 'Mean of DV'),
